...
<template>
      ...
      <section class="tags">
        <div class="wrapper">
          ...
          <div class="tag">
            <a href="#">
              <img
                src="../assets/homepage-career.png"
              />
            </a>
          </div>
        </div>
  ...
  .swiper {
    ...
    img {
      width: 100%;
      src: url("../assets/banner-mobile.png");
    }
    .text {
      padding: 2px 6px;
      font-size: 13px;
  ...
  .coffeehouse {
    ...
    .tag {
      ...
      top: 0;
      overflow: hidden;
      background-image: url("../assets/knowledge-01.png");
      padding-top: 168px;
    ...
    .tag:nth-child(2) {
      background-image: url("../assets/knowledge-02.png");
    }
    .tag:nth-child(3) {
      background-image: url("../assets/knowledge-03.png");
  }
  footer {
    p {
      text-align: center;
...
<template>
  ...
  .swiper {
    ...
    img {
      width: 100%;
      src: url("https://www-static.chinacdn.starbucks.com.cn/prod/assets/images/featured/club_upgrade/banner_mobile.jpg");
    }
    .text {
      padding: 2px 6px;
      font-size: 13px;
  ...
  @media (max-width: 640px) {
    .swiper {
      img {
        content: url("https://www-static.chinacdn.starbucks.com.cn/prod/assets/images/featured/club_upgrade/banner_mobile.jpg");
      }
    }
...
>>>>>>> 44f90f0b030a0701f3176e1a7561293b0d1fcbd1
